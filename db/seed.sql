insert into agents(id,name,wallet_address,status) values('11111111-1111-4111-8111-111111111111','Staging Demo Agent','g1qqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqq','active') on conflict do nothing;
...
values('22222222-2222-4222-8222-222222222222','11111111-1111-4111-8111-111111111111',true,'gno:staging',array['g1pppppppppppppppppppppppppppppppppppppp'],array['gno.land/r/gnoland/wugnot'],1000000,10000000,100000000,250000,now(),now()+interval '10 years') on conflict do nothing;
