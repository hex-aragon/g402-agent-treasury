...
var client_references_default = {
	"15c18cfaeeff": async () => {
		const m = await import("./assets/layout-segment-context-CJ7X39cV.js");
		return { get "LayoutSegmentProvider"() {
			return m["LayoutSegmentProvider"];
		} };
	},
	"3a0f04776db4": async () => {
		const m = await import("./assets/WalletClient-BCJMrKh3.js");
		return { get "default"() {
			return m["default"];
		} };
	},
	"593f344dc510": async () => {
		const m = await import("./assets/error-boundary-wYjJHlAP.js");
		return {
			get "ErrorBoundary"() {
	...
	"9a08bb4a3917": async () => {
		const m = await import("./assets/CosmosWallet-BCtd5a_t.js");
		return { get "default"() {
			return m["default"];
		} };
	},
	"c2747888630f": async () => {
		const m = await import("./assets/link-B8XSQoK8.js");
		return { get "default"() {
			return m["default"];
		} };
	}
...
//#endregion
export { __commonJSMin as C, __toESM as D, __toCommonJS as E, stripBasePath as S, __exportAll as T, isDangerousScheme as _, getPrefetchedUrls as a, VINEXT_MOUNTED_SLOTS_HEADER as b, usePathname as c, createRscRequestUrl as d, app_ssr_entry_default as default, isHashOnlyBrowserUrlChange as f, withBasePath as g, toSameOriginAppPath as h, handleSsr, getMountedSlotsHeader as i, useRouter as l, toBrowserNavigationHref as m, getCurrentInterceptionContext as n, navigateClientSide as o, resolveRelativeHref as p, getLayoutSegmentContext as r, prefetchRscResponse as s, require_jsx_runtime as t, createRscRequestHeaders as u, AppElementsWire as v, __esmMin as w, hasBasePath as x, require_react as y };
